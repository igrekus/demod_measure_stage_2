...
class PrimaryPlotWidget(QWidget):
    ...
    def __init__(self, parent=None, controller=None):
        ...
        self._plot_00.addLegend(offset=(rect.x() + 200, rect.y() + rect.height() - 50))
        ...
        self._plot_01.setLabel('left', 'P1дБвх, дБм', **self.label_style)
        ...
        self._plot_01.addLegend(offset=(rect.x() + 200, rect.y() + rect.height() - 50))
